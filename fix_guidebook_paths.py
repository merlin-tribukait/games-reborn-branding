...
<main class="guide-container">
    ...
    <section class="guide-section" id="vectors">
        ...
        <div class="assets-grid">
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/brand_grid_construction.svg" alt="Construction Blueprint Grid">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                    ...
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/brand_grid_construction.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
        </div>
...
# Write root BRAND_GUIDEBOOK.html (pointing to reborn_3d_brand_system/)
