...
<head>
    ...
    <link rel="icon" type="image/png" href="{prefix}03_app_icons_favicons/favicon-32x32.png">
    ...
    <link rel="stylesheet" href="{prefix}07_design_tokens_and_code/brand_styles.css">
    <style>
        * {{ margin: 0; padding: 0; box-sizing: border-box; }}
        ...
        .bg-btn.active {{
            box-shadow: 0 0 10px var(--dr-primary-glow);
        ...
        .asset-preview.bg-checkered {{
            background-color: #1a1c23;
            background-image: linear-gradient(45deg, #12141a 25%, transparent 25%), 
...
<nav class="brand-nav">
    <a href="#" class="brand-logo-lockup">
        <img src="{prefix}01_vectors_svg/logo_horizontal_wordmark.svg" alt="Dark Reborn 3D">
    </a>
...
<header class="guide-hero">
    ...
    <p class="guide-subtitle">100% Transparent Zero-Background Vector SVGs and 4K Renders for high-performance esports, web applications, and physical merch.</p>
    
    <div class="bg-switcher-bar">
        <span class="bg-switcher-label">Test Background Transparency:</span>
        <button class="bg-btn active" style="background:#090a0d; color:#fff;" onclick="setPreviewBg('dark', this)">Dark Grid</button>
        <button class="bg-btn" style="background:#1a1c23; color:#ff3344;" onclick="setPreviewBg('checkered', this)">Checkerboard</button>
        <button class="bg-btn" style="background:#f0f2f6; color:#111;" onclick="setPreviewBg('light', this)">Pure Light</button>
        <button class="bg-btn" style="background:#4a0808; color:#fff;" onclick="setPreviewBg('red', this)">Crimson Glow</button>
    </div>
</header>
...
<main class="guide-container">
    ...
    <section class="guide-section" id="vectors">
        <div class="section-header-wrap">
            ...
            <h2 class="section-heading">100% Transparent Vector SVGs</h2>
            <p class="section-lead">Zero background pixels, clean transparent alpha cutouts, responsive viewboxes, and pixel-perfect 3D metallic textures.</p>
        </div>

        <div class="assets-grid">
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_primary_3d_lockup.svg" alt="Primary 3D Shield Vector">
                </div>
                <div class="asset-details">
                    <div>
                        ...
                        <p class="asset-desc">100% transparent zero-background SVG with 3D brushed titanium finish and ruby red neon laser glow.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_primary_3d_lockup.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_horizontal_wordmark.svg" alt="Horizontal Nav Wordmark">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                        ...
                        <p class="asset-desc">Transparent wide header SVG formatted for navbars, live streams, and horizontal headers.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_horizontal_wordmark.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_crest_shield.svg" alt="Angular Cyber Crest">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                            <h4 class="asset-title">Angular Cyber Shield Crest</h4>
                            <span class="format-badge">SVG Vector</span>
                        </div>
                        <p class="asset-desc">Standalone angular crest emblem with transparent edges and laser underglow.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_crest_shield.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_metallic_wordmark.svg" alt="3D Metallic Wordmark">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                            <h4 class="asset-title">3D Metallic Wordmark</h4>
                            <span class="format-badge">SVG Vector</span>
                        </div>
                        <p class="asset-desc">Beveled GAMES REBORN metallic logotype with 100% transparent background.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_metallic_wordmark.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_cyber_wing.svg" alt="Cyber Wing Badge">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                            <h4 class="asset-title">Cyber Wing Badge</h4>
                            <span class="format-badge">SVG Vector</span>
                        </div>
                        <p class="asset-desc">Esports championship wing seal with transparent background.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_cyber_wing.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_monogram_icon.svg" alt="Monogram Squircle Icon">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                        ...
                        <p class="asset-desc">Squircle app icon monogram container with transparent outer boundary.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_monogram_icon.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}01_vectors_svg/logo_monochrome_white.svg" alt="Monochrome White">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                        ...
                        <p class="asset-desc">Pure white vector mark with 100% transparent background for dark fabrics and laser cutting.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_monochrome_white.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview" style="background: #e5e8ef;">
                    <img src="{prefix}01_vectors_svg/logo_monochrome_black.svg" alt="Monochrome Black">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                        ...
                        <p class="asset-desc">Pure black vector mark with 100% transparent background for light stationary and stamps.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}01_vectors_svg/logo_monochrome_black.svg" download class="btn-download">Download SVG ↓</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="guide-section" id="pngs">
        <div class="section-header-wrap">
            ...
            <p class="section-lead">32-bit alpha channel cutouts rendered at up to 4096×4096 resolution for compositing on any background.</p>
        </div>

        <div class="assets-grid">
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}02_transparent_png/primary_logo_4k_transparent.png" alt="4K Transparent Shield">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                    ...
                    <div class="asset-btn-bar">
                        <a href="{prefix}02_transparent_png/primary_logo_4k_transparent.png" download class="btn-download">Download 4K PNG ↓</a>
                        <a href="{prefix}02_transparent_png/primary_logo_2k_transparent.png" download class="btn-download">2K PNG</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}02_transparent_png/horizontal_nav_lockup.png" alt="3D Horizontal Lockup">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                            <h4 class="asset-title">3D Horizontal Lockup</h4>
                            <span class="format-badge">PNG Cutout</span>
                        </div>
                        <p class="asset-desc">Faceted 3D emblem accompanied by GAMES REBORN typography.</p>
                    </div>
                    <div class="asset-btn-bar">
                        <a href="{prefix}02_transparent_png/horizontal_nav_lockup.png" download class="btn-download">Download PNG ↓</a>
                    </div>
                </div>
            </div>
            ...
            <div class="asset-card">
                <div class="asset-preview">
                    <img src="{prefix}02_transparent_png/crest_shield.png" alt="Angular Cyber Crest">
                </div>
                <div class="asset-details">
                    <div>
                        <div class="asset-title-row">
                    ...
                    <div class="asset-btn-bar">
                        <a href="{prefix}02_transparent_png/crest_shield.png" download class="btn-download">Download PNG ↓</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="mockups-grid">
            <div class="mockup-item">
                <div class="mockup-img-wrap">
                    <img src="{prefix}06_merch_and_mockups/mockup_battlestation_desk_setup.png" alt="Battlestation Desk Setup">
                </div>
            ...
            <div class="mockup-item">
                <div class="mockup-img-wrap">
                    <img src="{prefix}06_merch_and_mockups/mockup_esports_jersey_hoodie.png" alt="Esports Jersey & Hoodie">
                </div>
                <div class="mockup-desc">
            ...
            <div class="mockup-item" style="grid-column: span 2;">
                <div class="mockup-img-wrap">
                    <img src="{prefix}06_merch_and_mockups/mockup_cinematic_5k_header.jpg" alt="5K Wide Cinematic Header">
                </div>
                <div class="mockup-desc">
  ...
  "fonts": {{
    ...
    "body": "'Rajdhani', sans-serif"
                ...
                <div style="margin-top: 15px;">
                    <a href="{prefix}07_design_tokens_and_code/brand_tokens.json" download class="btn-download">Download JSON Tokens ↓</a>
                </div>
            </div>
      ...
      colors: {{
        reborn: {{
          ...
          obsidian: '#060709'
                ...
                <div style="margin-top: 15px;">
                    <a href="{prefix}07_design_tokens_and_code/brand_styles.css" download class="btn-download">Download CSS Stylesheet ↓</a>
                </div>
            </div>
        </div>
    </section>
...
function setPreviewBg(mode, btn) {{
    ...
    document.querySelectorAll('.asset-preview').forEach(p => {{
        p.className = 'asset-preview';
        if (mode === 'checkered') p.classList.add('bg-checkered');
        else if (mode === 'light') p.classList.add('bg-light');
        else if (mode === 'red') p.classList.add('bg-red');
    }});
}}
</script>
...
# Write root BRAND_GUIDEBOOK.html
with open(os.path.join(base_dir, "BRAND_GUIDEBOOK.html"), "w", encoding="utf-8") as f:
    f.write(get_guidebook_html("reborn_3d_brand_system/"))

# Write internal BRAND_GUIDEBOOK.html
with open(os.path.join(brand_sys, "BRAND_GUIDEBOOK.html"), "w", encoding="utf-8") as f:
    f.write(get_guidebook_html(""))

print("Brand Guidebook updated with Live Background Switcher!")
